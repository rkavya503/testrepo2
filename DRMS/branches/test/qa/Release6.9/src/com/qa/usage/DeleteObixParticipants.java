...
public class DeleteObixParticipants extends SeleneseTestCase {
	//serverDeleteContacts.config has the information for these variables.
	String Server = "";
	String Username = "";
	String Password = "";
	//Participant root, such as "TestX"
	String Participant = "";
	int Count = 0;
	...
	private void readConfigFile() throws Exception {
		try{
			...
			FileInputStream fstream = new FileInputStream("serverDeleteUsageParticipants.config");
	...
	public void testDeleteParticipants() throws Exception {
		...
		String participantPrefix = Participant;
		String partName = "";
		int count = Count;
		try {
