...
private void readConfigFile() throws Exception {
	try{
	    ...
	    FileInputStream fstream = new FileInputStream("serverRTP.config");
...
private void saveStrategy (String participantName){
    ...
    //      selenium.click("//tbody[@id='navForm:strategies:tb']/tr[1]/td[4]/span/input");
    //      selenium.click("//tbody[@id='navForm:strategies:tb']/tr[1]/td[5]/span/input");
    //      selenium.click("//tbody[@id='navForm:strategies:tb']/tr[1]/td[6]/span/input");
        //row 2, summer, winter, weekend
    //      selenium.click("//tbody[@id='navForm:strategies:tb']/tr[2]/td[4]/span/input");
    //      selenium.click("//tbody[@id='navForm:strategies:tb']/tr[2]/td[5]/span/input");
   //html/body/form/div[2]/div/table/tbody/tr[2]/td[6]/input
    //tbody/tr[2]/td[6]/input[@type='checkbox' and @title='Weekend']
    
    if (participantName == "Zelda" )
    	 selenium.click("//tbody/tr[2]/td[6]/input[@type='checkbox' and @title='Weekend']");
    //    selenium.click("//tbody[@id='navForm:strategies:tb']/tr[2]/td[6]/span/input[@type='checkbox' and @title='Weekend']");
   // 	selenium.click("//form/div[2]/div/table/tbody/tr/td[6]/span/input[@type='checkbox' and @title='Weekend']");
    else if (participantName == "Zeke" ) {
  //      selenium.click("//tbody[@id='navForm:strategies:tb']/tr[2]/td[4]/span/input[@type='checkbox' and @title='Summer']");
  //      selenium.click("//tbody[@id='navForm:strategies:tb']/tr[2]/td[5]/span/input[@type='checkbox' and @title='Winter']");
  //      selenium.click("//tbody[@id='navForm:strategies:tb']/tr[2]/td[6]/span/input[@type='checkbox' and @title='Weekend']");
...
public void testCreateZParticipants() throws Exception {
    ...
    String [] programName = {"RTP <2KV", "RTP 2KV-50KV", "RTP >50KV", "RTP Agricultural", "RTP <2KV B", "RTP <2KV"};
