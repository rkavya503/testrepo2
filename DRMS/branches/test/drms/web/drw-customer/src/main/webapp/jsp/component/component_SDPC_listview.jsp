...
<h:panelGroup id="SDPCRefreshPanel" layout="block">
<h:panelGroup  layout="block"  id="SDPCPanel" >	
        <div class="planPurpleHeaderBg"><h3>Summer Discount Plan (SDP) - Commercial</h3></div>   
	<h:panelGroup  layout="block"  id="innerSDPCPanel">
		<h:panelGroup  layout="block"  rendered="#{drListView.groupSDPC.eventEmptyFlag}">	
		...
		<h:panelGroup  layout="block"  rendered="#{!drListView.groupSDPC.eventEmptyFlag}" id="sdpcActiveEventsPanel">	
			<h:panelGroup  layout="block"  id="sdpcSearchNoEventsPanel" style="display:none">	
			<div class="dividerGrayLine"></div>
				<table class="resultTable2">
				  <tr>
			...
			<h:panelGroup id="sdpcActiveEventsDisplayPanel"  layout="block"  >	
			
				
				<rich:dataList var="event" value="#{drListView.groupSDPC.events}" rows="100" style="list-style-type:none;">
			...
			<h:panelGroup layout="block" rendered="#{!drListView.groupSDPC.eventEmptyFlag}" >
                <div class="viewEventAreas" style="color: #666;margin-left:10px;" >
                    <h:outputText value="End Times for SDP Commercial events are determined by grid reliability and cannot be estimated by SCE."/>
                </div>
            </h:panelGroup>
