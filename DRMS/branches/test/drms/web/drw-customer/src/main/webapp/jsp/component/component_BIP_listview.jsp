...
<h:panelGroup id="BIPRefreshPanel" layout="block">
<h:panelGroup  layout="block"  id="BIPPanel" >	
		<div class="planBlackHeaderBg"><h3>Base Interruptible Program (BIP)</h3></div>
		<h:panelGroup  layout="block"  id="innerBIPPanel">
		<h:panelGroup  layout="block"  rendered="#{drListView.groupBIP.eventEmptyFlag}">	
		...
		<h:panelGroup  layout="block"  rendered="#{!drListView.groupBIP.eventEmptyFlag}" id="bipActiveEventsPanel" >
			<h:panelGroup  layout="block"  id="bipSearchNoEventsPanel" style="display:none">	
			<div class="dividerGrayLine"></div>
				<table class="resultTable2">
				  <tr>
			...
			<h:panelGroup id="bipActiveEventsDisplayPanel"  layout="block" >	
			
				
				<rich:dataList var="event" value="#{drListView.groupBIP.events}" rows="100" style="list-style-type:none;">
