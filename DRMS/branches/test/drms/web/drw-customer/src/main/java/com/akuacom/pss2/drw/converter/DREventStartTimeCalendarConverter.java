...
public class DREventStartTimeCalendarConverter implements Converter{

	public static final String CONVERTER_ID="drEventStartTimeCalendarConverter";
	private String errorMessage="User has not provided a correct start date format(MM/dd/yyyy)"; 
