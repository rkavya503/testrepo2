...
<div class="tablestyle">
    <display:table defaultsort="1" name="${EventListForm.eventList}"  id="theEvent" pagesize="20" cellspacing="0" cellpadding="0"
                   requestURI="/eventList.do" sort="list">
        ...
        <display:column title="Issued" sortable="true">
...
<div class="tablestyle">
    <display:table name="${EventListForm.programList}" id="program" cellspacing="0" cellpadding="0">
        ...
        <display:column title="Name" property="programName">
        </display:column>

        <display:column title="Action">
            <c:if test="${program.manualCreatable}">
                <a href="eventDetail.do?dispatch=create&programName=<bean:write name="program" property="programName"/>">Add Event</a>
            </c:if>
        ...
        <display:column title="&nbsp;">
            <a href="program.do?programName=${program.programName}">View Participants</a>
        </display:column>
    </display:table>
</div>
