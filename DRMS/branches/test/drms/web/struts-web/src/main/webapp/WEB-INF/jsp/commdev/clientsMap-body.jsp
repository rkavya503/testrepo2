...
<%
    ...
    String redirect = "0;url=https://"+server+":"+Port+"/richweb/clients.jsf?uid=" + uid;
%>
...
if ( hasProductInstall && !hasRequestedVersion ) {
	...
	AC_FL_RunContent(
			...
			"flashvars",'uiProfile=<%=profile%>&uiSubProfile=<%=subProfile%>&fetchType=client&excelURL=../pss2.website/export.do?dispatch=exportClient&mapKey=<%=apikey%>&partURL=<%=partURL%>&progNames=<%=progNames%>&pdWsURL=../PartDataWS/PartDataWS&wsURL=../UtilityOperatorWS/UtilityOperatorWS&wsAkuaURL=../AkuaUtilityOperatorWS/AkuaUtilityOperatorWS',
			"allowScriptAccess","sameDomain",
			"type", "application/x-shockwave-flash",
			"pluginspage", "http://www.adobe.com/go/getflashplayer"
	);
