...
if ( hasProductInstall && !hasRequestedVersion ) {
	...
	AC_FL_RunContent(
			...
			"name", "pss2",
			"allowScriptAccess","sameDomain",
            "flashvars",'programName=<%=progName%>&templateID=<%=eventName%>&saveEvent=<%=saveEvent%>&issueEvent=false&uiProfile=DEMO&serverTime=<%=serverTime%>&timezoneOffset=<%=timezoneOffset%>&wsURL=../UtilityOperatorWS/UtilityOperatorWS&wsAkuaURL=../AkuaUtilityOperatorWS/AkuaUtilityOperatorWS',
            "type", "application/x-shockwave-flash",
			"pluginspage", "http://www.adobe.com/go/getflashplayer"
	);
