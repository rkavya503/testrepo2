...
<body>
	<a4j:keepAlive beanName="sdpEventAdvisor"/>
	<richext:set beanName="evtAdvisor" value="#{sdpEventAdvisor}"/>
	<richext:set beanName="demoEvent" value="#{evtAdvisor.eventModel.sdpEvent}"/>
	<h:form id="navForm">
	...
	<rich:panel id="event-creation-wizard" styleClass="wizard-panel">
		...
		<rich:tabPanel selectedTab="#{evtAdvisor.eventModel.activePage}" 
			...
			<richext:tab label="participants"  id="locationSelection" status ="waitStatus" showHeader="false">
				<jsp:include page="locationSelection.jsp" />
			</richext:tab>
