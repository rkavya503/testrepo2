...
<rich:panel styleClass="wizard-title-container">
	<span class="wizard-title">SDP - History Events</span>
</rich:panel> 
...
<table width="900px" >
	<tr>
		<td>
			<h:panelGrid styleClass="filter-form-block" columns="3" id="reject-filter-block" style="width:100%">
				...
				<h:panelGroup >
                    <h:outputText style="text-align: left;font-size:11px"   value="Rates:"/>                       
                    <h:selectOneMenu   style="padding-left:5px;border: 1px solid;" value="#{historyEvents.rates}">
                         <f:selectItem itemValue="" itemLabel="ALL" />
                         <f:selectItem itemValue="APS" itemLabel="APS" />
                        <f:selectItem itemValue="APS-E" itemLabel="APS-E" />
                        <f:selectItem itemValue="SDP" itemLabel="SDP" />
                    </h:selectOneMenu>
                 </h:panelGroup> 
                ...
                <h:panelGroup >
                    ...
                    <h:inputText  value="#{historyEvents.locationName}" style="border: 1px solid;" />
                </h:panelGroup>
                
                <h:panelGroup >
					<h:outputText style="text-align: left;font-size:11px"  value="Dispatch Types : " />
					<h:selectOneMenu  style="padding-left:5px;border: 1px solid;" value="#{historyEvents.dispatchTypeFilter}">
                ...
                <h:panelGroup>
                       <a4j:commandButton id="apply-select-filter" value="Go" styleClass="cmd-button" style="width:auto;"
                              action="#{historyEvents.applyFilter}" title="filter in history events"
                              limitToList="true"
                              reRender="msg-block,confirmParticipantList"/> 
                         <h:commandButton
                                value="     Export    " title="Export Result"
                                action="#{historyEvents.exportExcel}"
	...
	<tr>
		 <td id="enrolled-table-col">		
			<richext:treeTable id="confirmParticipantList" value="#{historyEvents.locationProvider}" var="item" rows="10000"  selectionMode="multiple"
...
<rich:panel styleClass="wizard-button-container" style="border-top: 1px solid #DDDDDD"> 
	...
	<a4j:commandButton value="Exit" styleClass="wizard-btn" 
			action="#{historyEvents.doExit}" title="Exit"
