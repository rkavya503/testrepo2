...
<a4j:keepAlive beanName="apiHistoryEvents"/>

<rich:panel styleClass="wizard-title-container">
    <span class="wizard-title">API - History Events</span>
</rich:panel> 
...
<table width="900px">
        ...
        <td>
                ...
                <h:panelGroup>
                    ...
                    <rich:calendar id="startTime"
                          value="#{apiHistoryEvents.startTime}"  
                    ...
                    <rich:calendar id="endTime"
                          value="#{apiHistoryEvents.endTime}"  
                          datePattern="MM-d-yyyy"
                          popup="true">
                    </rich:calendar>
                    </a4j:region>     
                ...
                <h:panelGroup >
                    ...
                    <h:inputText  value="#{apiHistoryEvents.locationName}" style="border: 1px solid;" />
                </h:panelGroup>
                
                <h:panelGroup >
					<h:outputText style="text-align: left;font-size:11px"  value="Dispatch Types : " />
					<h:selectOneMenu  style="padding-left:5px;border: 1px solid;" value="#{apiHistoryEvents.dispatchTypeFilter}">
                ...
                <h:panelGroup>
                       <a4j:commandButton id="apply-select-filter" value="Go" styleClass="cmd-button" style="width:auto;"
                              action="#{apiHistoryEvents.applyFilter}" title="filter in history events"
                              limitToList="true"
                              reRender="msg-block,confirmParticipantList"/> 
                         <h:commandButton
                                value="     Export    " title="Export Result"
                                action="#{apiHistoryEvents.exportExcel}"
    ...
    <tr>
        <td id="enrolled-table-col">            
            <richext:treeTable id="confirmParticipantList" value="#{apiHistoryEvents.locationProvider}" var="item" rows="10000"  selectionMode="multiple"
...
<rich:panel styleClass="wizard-button-container" style="border-top: 1px solid #DDDDDD" > 
    ...
    <a4j:commandButton value="Exit" styleClass="wizard-btn" 
            action="#{apiHistoryEvents.doExit}" title="Exit"
