...
<richext:set beanName="evtTiming" value="#{evtAdvisor.eventModel.eventTiming}"/>
	...
	<h:panelGroup >
	 ...
	 <a4j:region>
        <h:panelGroup>
            ...
            &nbsp;
			<h:outputText style="color: #3C78B5; font-size:11px;font-weight:normal" value="If you leave this field blank, the system uses the event Creation Date & Time. "/>
        </h:panelGroup>
    </a4j:region>  
    ...
    <h:selectOneRadio value="#{demoEvent.rates}" styleClass="selfDefinedFontRadio" required="true">     
