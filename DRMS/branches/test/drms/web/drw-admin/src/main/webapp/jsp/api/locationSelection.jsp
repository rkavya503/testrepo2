...
<rich:panel styleClass="wizard-title-container">
    <span class="wizard-title"> API - Select Dispatch Locations </span>
</rich:panel> 
                    ...
                    <tr>
                        <td colspan="3" id="rejected-part-col" align="right">
                            <richext:treeTable id="rejectedParticipantList" 
                                ...
                                <rich:column sortBy="#{name}" sortable="true" width="50%">
                                    <f:facet name="header">
                                           <h:outputText value="Location Name" escape="false"/>
                                       </f:facet>               
                                    <h:outputText/>
                                ...
                                <rich:column sortBy="#{number}" sortable="true" width="45%">
                                    <f:facet name="header">
                                       <h:outputText value="Location#" escape="false"/>
                                   </f:facet>               
                                    <h:outputText/>
