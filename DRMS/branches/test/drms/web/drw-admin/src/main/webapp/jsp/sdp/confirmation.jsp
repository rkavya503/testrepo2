...
<rich:panel styleClass="wizard-title-container">
	<span class="wizard-title">SDP - Issue Events</span>
</rich:panel> 
...
<table width="900px">
	<tr>
		...
		<td><h:outputText style="text-align: left;font-size:11px"   value="Rate:"/>&nbsp;&nbsp;	
		<h:outputText value="#{demoEvent.rates}" style="text-align: left;font-size:11px" >
		</h:outputText>	
		</td> 
