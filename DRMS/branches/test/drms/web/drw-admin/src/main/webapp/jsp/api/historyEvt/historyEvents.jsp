...
<body onload="initPage()">
            ...
            <f:facet name="header">
                <rich:columnGroup>
                    <rich:column  style="text-align:left;font-size: 13px;">
                        <h:outputText value="#{apiHistoryEvents.programName}"/>
                    </rich:column>
    ...
    <rich:panel id="event-creation-wizard" styleClass="wizard-panel">
        ...
        <rich:tabPanel selectedTab="#{apiHistoryEvents.activePage}" 
                       switchType="ajax"
                       headerClass="wizard-header">
            <richext:tab label="list" id="eventList" status ="waitStatus" showHeader="false" oncomplete="alert('C123')">                        
     ...
     <rich:modalPanel id="comfirmpanel" autosized="false"
            ...
            <h:form onsubmit="" id="deleteForm">
                ...
                <a4j:commandButton id="yes" value="Yes"
                    ...
                    action="#{apiHistoryEvents.doDelete}"
