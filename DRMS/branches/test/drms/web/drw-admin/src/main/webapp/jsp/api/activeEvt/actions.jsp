...
<rich:panel styleClass="wizard-title-container">
	<span class="wizard-title">API - Update Active Events Estimated End Date&Time</span>
</rich:panel> 
...
<rich:panel styleClass="wizard-button-container" style="border-top: 1px solid #DDDDDD"> 
	...
	<a4j:commandButton value="Cancel" reRender="event-creation-wizard" action="#{activeEvents.doCancel}" immediate="true" title="Cancel" styleClass="wizard-btn"/>
