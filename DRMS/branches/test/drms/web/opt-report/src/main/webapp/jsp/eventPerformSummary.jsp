...
<BR><BR>
	...
	<h:outputText value="No participants found in the event" styleClass="not-found-msg" 
		rendered="#{report.events.reportPerformanceTree.totalRowCount==0}"/>
</h:panelGroup>
