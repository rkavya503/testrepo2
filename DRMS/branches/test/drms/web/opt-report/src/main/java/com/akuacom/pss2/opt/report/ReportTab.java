...
public abstract class ReportTab implements Serializable{
	...
	private OperatorReports.Tab reportTab;
	...
	public ReportTab(OperatorReports report,OperatorReports.Tab tab,SearchCriteria.FILTER... searchFilters){
		this.report = report;
	...
	public String validate(){
		...
		if(sc.getFilterByObject()==null){
			return "Participant(s) or event  is required ";
		}
	...
	public void setReport(OperatorReports report) {
		this.report = report;
	}

	public OperatorReports.Tab getReportTab() {
		return reportTab;
	}
}
