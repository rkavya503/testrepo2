...
<h:panelGrid columns="4" style="font-size:11px">
	...
	<a4j:region>
		<h:inputText id="notificationTime"  styleClass="time-input"
	...
	<a4j:region>
		<rich:calendar id="notificationTimeCal" label="notification Date"
			  ...
			  popup="true">
			<a4j:support event="onchanged" action="#{demoEvent.updateModel}" reRender="msg-block,timing,events" 
					 limitToList="true"/> 
		</rich:calendar>
	</a4j:region>
    <a4j:region >
...
<h:selectOneRadio value="#{demoEvent.selectedCreationType}" id="controlStateSelectRadio"
										...
										style="font-size:11px;width:160px;line-height:normal;text-align: left;">
...
<h:panelGrid columns="4" style="font-size:11px">	
	...
	<a4j:region>
		<h:inputText id="notice"  styleClass="time-input"
	...
	<a4j:region>
		<h:inputText id="startTime" styleClass="time-input"
	...
	<a4j:region>
		<h:inputText id="duration" styleClass="time-input"
	...
	<a4j:region>
		<h:inputText id="endTime"  styleClass="time-input"
