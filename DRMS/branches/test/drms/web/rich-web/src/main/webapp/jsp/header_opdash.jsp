...
<h:panelGroup styleClass="#{header1.headerStyle}" layout="block" id="page_wrapper">
	<div class="header">
		...
		<ul id="nav">
			...
			<li id="programs"><h:outputLink
					value="/pss2.website/uoProgram.do">
			...
			<li id="clients"><h:outputLink
					value="/pss2.website/clientsMap.do">
			...
			<li id="Reports"><h:outputLink value="/pss2.website/logList.do">
            ...
            <li id="current"><h:outputLink value="/pss2.website/about.do">
                    <f:verbatim> Dashboard </f:verbatim>
                </h:outputLink></li>
       ...
       <h:outputLink id="scorecardlink" target="_blank"
		...
		<ul id="navright">
			...
			<li><h:outputText value="#{header1.utilityName}" /></li>
