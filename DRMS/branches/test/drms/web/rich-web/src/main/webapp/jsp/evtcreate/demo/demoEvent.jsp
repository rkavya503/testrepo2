...
<f:view>
	<a4j:keepAlive beanName="demoEventAdvisor"/>
	<richext:set beanName="evtAdvisor" value="#{demoEventAdvisor}"/>
	<richext:set beanName="demoEvent" value="#{evtAdvisor.eventModel.demoEvent}"/>
	...
	<rich:panel id="event-creation-wizard" styleClass="wizard-panel">
		...
		<rich:tabPanel selectedTab="#{evtAdvisor.eventModel.activePage}" 
			...
			<richext:tab label="Event Timing" id="eventSchedule" status ="waitStatus" showHeader="false"> 
				<jsp:include page="demoEventSchedule.jsp"/>
			</richext:tab>
			<richext:tab label="participants"  id="participantSelection" status ="waitStatus" showHeader="false">
				<jsp:include page="../participantSelection.jsp" />
			</richext:tab>
