...
<f:view>
	...
	<h:form id="form">
		...
		<h:panelGrid columns="3" styleClass="event-panel-grid">
			...
			<h:panelGroup>
				<rich:calendar value="#{eventDataModel.issuedTime}" id="issueTimeCalendar"  
			...
			<h:message for="issueTimeCalendar" errorClass="message-error"  />
			...
			<h:panelGroup>
				<h:selectOneMenu value="#{eventDataModel.issuedHour}">                     
                    <f:selectItems value="#{eventDataModel.hourList}"/> 
                </h:selectOneMenu>
				:
				<h:selectOneMenu value="#{eventDataModel.issuedMin}">                     
