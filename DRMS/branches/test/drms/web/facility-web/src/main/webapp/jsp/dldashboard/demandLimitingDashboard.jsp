...
<title>Demand Limiting Dashboard for <h:outputText value="#{demandLimitingDashboard.participantName}"/> - ©2011. Honeywell International Inc. </title>
...
<link rel="stylesheet" href="resources/badge/style-transitions.css"
	...
	<body>
		...
		<h:form id="dashboardForm">
			<rich:panel>
				<h:inputHidden id="intervalLoad"
					value="#{demandLimitingDashboard.demandLimitingProgramParticipantState.intervalLoad}" />
				<h:inputHidden id="tariffLimit"
					value="#{demandLimitingDashboard.demandLimitingProgramParticipantState.tariffLimit}" />
				<h:inputHidden id="normalThreshold"
					value="#{demandLimitingDashboard.demandLimitingProgramParticipantState.normalThreshold}" />
				<h:inputHidden id="warningThreshold"
					value="#{demandLimitingDashboard.demandLimitingProgramParticipantState.warningThreshold}" />
				<h:inputHidden id="moderateThreshold"
					value="#{demandLimitingDashboard.demandLimitingProgramParticipantState.moderateThreshold}" />
				<h:inputHidden id="highThreshold"
					value="#{demandLimitingDashboard.demandLimitingProgramParticipantState.highThreshold}" />
				<h:inputHidden id="exceededThreshold"
					value="#{demandLimitingDashboard.demandLimitingProgramParticipantState.exceededThreshold}" />
				<h:inputHidden id="intervalLoadColor"
					value="#{demandLimitingDashboard.intervalLoadColor}" />
				<h:inputHidden id="meterMax"
					value="#{demandLimitingDashboard.meterMax}" />
				...
				<script type="text/javascript">
					...
					jQuery(document)
							.ready(
									function() {
										s1 = [ <h:outputText value="#{demandLimitingDashboard.demandLimitingProgramParticipantState.intervalLoad}" /> ];
										plot5 = jQuery
												.jqplot(
														'chart5',
														[ s1 ],
				...
				<div id="badge_container">
					<div id="badge">
						<h1 id="badge_text">
							<h:outputText value="#{demandLimitingDashboard.intervalLoadStr}" />
						</h1>
					</div>
