...
@Stateless
public class BaselineFiveTenModelBean implements BaselineFiveTenModel.R,
BaselineFiveTenModel.L {
    ...
    public static String MODELNAME = "FiveTen";
    ...
    public List<PDataEntry> calculate(List<String> datasourceUUIDs, Date date) {
        BaselineModel mb = bmManager
                .getBaselineModelByName(BaselineFiveTenModelBean.MODELNAME);
