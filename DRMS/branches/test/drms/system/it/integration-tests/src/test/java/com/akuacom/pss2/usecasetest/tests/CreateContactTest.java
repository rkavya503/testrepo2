...
/**
 * Create Contact Integration Test
 * @author Jowey
 */
public class CreateContactTest extends UsecaseTestBase{
    ...
    public void runCase () throws Exception {
        ...
        //3. Create Contact
        runCase (new CreateContactUsecase(client, type, address, name, commNotification, offSeasonNotiHours, onSeasonNotiHours, eventNotification, msgThreshold));
        //4. Clean test data
